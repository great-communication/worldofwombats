  ...
  const Color& backgroundColor, double lightValue) const
{
  ...
  // the new color.
  Color newColor (
    (noise::uint8)((noise::uintfix)(red   * 255.0) & 0xff),
    (noise::uint8)((noise::uintfix)(green * 255.0) & 0xff),
    (noise::uint8)((noise::uintfix)(blue  * 255.0) & 0xff),
  ...
  double bumpHeight) const
{
  ...
  xc = (noise::uint8)((noise::uintfix)((floor)((vxc + 1.0) * 127.5)) & 0xff);
  yc = (noise::uint8)((noise::uintfix)((floor)((vyc + 1.0) * 127.5)) & 0xff);
  zc = (noise::uint8)((noise::uintfix)((floor)((vzc + 1.0) * 127.5)) & 0xff);
